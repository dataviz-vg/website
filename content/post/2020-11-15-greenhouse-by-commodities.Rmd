...
::: {.quote}
> The production of animal-based foods is associated with higher greenhouse gas (GHG) emissions than plant-based foods. The objective of this study was to estimate the difference in dietary GHG emissions between self-selected meat-eaters, fish-eaters, vegetarians and vegans in the UK.
:::
...
# library(tidyverse)
adjusted_table %>% 
  ggplot(aes(reorder(`Food category`, `UK GHG emissions (kgCO2e/kg)`), `UK GHG emissions (kgCO2e/kg)`, fill = type)) + 
  geom_col() + 
  coord_flip() + 
  labs(
