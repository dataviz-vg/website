---
title: "Worlwide Meat Production over the Years"
author: "Colin Fay"
date: 2020-11-08
slug: "worldwide-meat-production-over-years"
categories: ["industry"]
...
df$gg + 
  labs(
    title = "Meat production over the years"
  )
```
...
x <- df %>%
  ...
  guides(color = FALSE) + 
  labs(
    title = "Evolution of the meat production of 6 species",
    x = "Year", 
    y = sprintf(
      "Production in %s",
      "tonnes"
