---
title: "Worlwide Milk Production over the Years"
author: "Colin Fay"
date: 2020-12-06
slug: "worldwide-milk-production-over-years"
categories: ["industry"]
tags: ["livestock", "production", "industry"]
draft: true
params:
  table: milk-over-years.csv
---
...
adjusted_table %>%
  ...
  geom_col(fill = viridis::viridis(6)[2]) + 
  scale_y_continuous(labels = scales::comma) + 
  ggtheme() + 
  labs(
    title = "Global production (in tonnes) of mil over the years", 
    x = "", 
    y = "", 
